...
WebUI.verifyElementVisible(findTestObject('checkout/all subtotal price'))

WebUI.verifyElementVisible(findTestObject('checkout/all tax price'))

WebUI.verifyElementVisible(findTestObject('checkout/all total price'))
