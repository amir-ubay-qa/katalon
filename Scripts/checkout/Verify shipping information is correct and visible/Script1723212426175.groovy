...
WebUI.verifyElementVisible(findTestObject('checkout/summary info container'))

WebUI.verifyElementVisible(findTestObject('checkout/shipping information'))

WebUI.verifyElementVisible(findTestObject('checkout/shipping information value'))
