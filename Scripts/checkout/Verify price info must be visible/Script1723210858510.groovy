...
WebUI.verifyElementVisible(findTestObject('checkout/subtotal'))

WebUI.verifyElementVisible(findTestObject('checkout/tax'))

WebUI.verifyElementVisible(findTestObject('checkout/total'))
