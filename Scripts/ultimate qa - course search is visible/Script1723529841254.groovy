 ...
 * 2. Verify component search is visible
 * */
...
// Verify component search is visible
WebUI.verifyElementVisible(findTestObject('Page_Courses - Ultimate QA/component_search'))