 ...
 * 2. Find menu service
 * 3. Click menu service
 * 4. Verify page service is opened
 * */
...
// Find menu service
WebUI.click(findTestObject('Page_UltimateQA/menu_Service'))

// Click menu service
WebUI.click(findTestObject('Page_UltimateQA/menu_Service'))

// Verify page service is opened
WebUI.verifyElementVisible(findTestObject('Page_UltimateQA/page_Service'))