...
WebUI.setText(findTestObject('Object Repository/login-page/Username Input'), 'locked_out_user')
...
WebUI.verifyTextPresent('Epic sadface: Sorry, this user has been locked out.', false)
