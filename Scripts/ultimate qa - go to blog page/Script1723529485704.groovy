...
// Find menu blog
WebUI.click(findTestObject('Page_UltimateQA/menu_blog'))

// Click menu blog
WebUI.click(findTestObject('Page_UltimateQA/menu_blog'))

// Verify page blog is opened
WebUI.verifyElementVisible(findTestObject('Page_UltimateQA/page_blog'))