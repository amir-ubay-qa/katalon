 ...
 * 5. Clivk pagination prev
 * 6. Verify page 1 pagination is active
 * */
...
WebUI.click(findTestObject('Pagination_Next_Button'))

// Verify page 2 pagination is active
WebUI.verifyElementAttributeValue(findTestObject('Page_2_Pagination'), 'class', 'active', 10)

// Click pagination prev
WebUI.click(findTestObject('Pagination_Prev_Button'))

// Verify page 1 pagination is active
WebUI.verifyElementAttributeValue(findTestObject('Page_1_Pagination'), 'class', 'active', 10)