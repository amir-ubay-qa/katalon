 ...
 * 3. Verify courses count are 6 on first page
 * */
...
WebUI.verifyElementVisible(findTestObject('Page_Courses - Ultimate QA/coursesList'))

// Verify courses count are 6 on first page
WebUI.verifyElementCount(findTestObject('Page_Courses - Ultimate QA/courseItem'), 6)